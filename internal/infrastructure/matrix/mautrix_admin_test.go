...
// ============================================================================
// redactCanonicalAliasesFromRooms (admin.ListRooms)
// ============================================================================

func TestAdminAPI_RedactCanonicalAliases_ListRoomsError(t *testing.T) {
	mock := &mockAdminAPI{
		listRoomsErr: errors.New("admin API unavailable"),
	}
	a := newAdminTestAdapter(mock)
...
func TestAdminAPI_RedactCanonicalAliases_SkipsSpaces(t *testing.T) {
	mock := &mockAdminAPI{
		listRoomsResult: []AdminRoom{
			{
