...
func NewApp(cfg *config.Config) (*App, error) {
	...
	spaceService := service.NewSpaceService(matrixAdapter, log, idMapper, governanceService)
	...
	spaceHandler := queue.NewSpaceHandler(spaceService, governanceService, matrixAdapter, idMapper)
