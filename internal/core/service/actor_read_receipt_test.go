...
func (m *arMockMatrixPort) SendMessage(_ context.Context, _ id.RoomID, _ domain.Actor, _ string, _ []domain.Attachment, _ string) (id.EventID, error) {
	return "", nil
}
func (m *arMockMatrixPort) SendReply(_ context.Context, _ id.RoomID, _ domain.Actor, _ string, _ id.EventID, _ []domain.Attachment, _ string) (id.EventID, error) {
	return "", nil
}
